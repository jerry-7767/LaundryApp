...
public class IronAdapter extends RecyclerView.Adapter<IronAdapter.IronViewHolder> implements Filterable {

    private Context mContext;
    public ArrayList<SelectClothsPojo> selectClothsPojos;
    private SearchIron searchIron;
    ...
    public IronAdapter(ArrayList<SelectClothsPojo> selectClothsPojos, Context context) {
...
//        View view = LayoutInflater.from(mContext).inflate(R.layout.single_addtocrt_dialog,null);
        builder.setContentView(R.layout.single_addtocrt_iron_dialog);
        ImageView clthimg = builder.findViewById(R.id.imgvw_dialog_clth_image_iron);
        TextView clthname = builder.findViewById(R.id.txtvw_clth_dialog_name_iron);
        TextView clthperprice = builder.findViewById(R.id.txtvw_clth_dialog_perpiece_price_iron);
        TextView clthtotalprice = builder.findViewById(R.id.txtvw_clth_dialog_total_price_iron);
        ImageView incrbtn = builder.findViewById(R.id.imgvw_decrement_quantity_iron);
        ImageView decrbtn = builder.findViewById(R.id.imgvw_increment_quantity_iron);
        TextView quantitytext = builder.findViewById(R.id.txtvw_quantity_iron);
        TextView catg_namee = builder.findViewById(R.id.txtvw_dialog_catg_name_iron);
        Button addbagbtn = builder.findViewById(R.id.btn_add_to_bag_iron);
...
//        AlertDialog dialog = builder.create();
    ...
    public Filter getFilter() {
        if (searchIron==null){
            searchIron = new SearchIron(this,selectClothsPojos);
        }
        return searchIron;
    }

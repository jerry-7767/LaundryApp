...
import com.example.laundryapp.SearchF.SearchDryClean;
...
public class DrycleanAdapter extends RecyclerView.Adapter<DrycleanAdapter.IronViewHolder> implements Filterable {

    private Context mContext;
    public ArrayList<SelectClothsPojo> selectClothsPojos;
    private SearchDryClean searchDryClean;
    ...
    public DrycleanAdapter(ArrayList<SelectClothsPojo> selectClothsPojos, Context context) {
...
//        View view = LayoutInflater.from(mContext).inflate(R.layout.single_addtocrt_dialog,null);
        builder.setContentView(R.layout.single_addtocrt_dry_clean_dialog);
        ImageView clthimg = builder.findViewById(R.id.imgvw_dialog_clth_image_dry_clean);
        TextView clthname = builder.findViewById(R.id.txtvw_clth_dialog_name_dry_clean);
        TextView clthperprice = builder.findViewById(R.id.txtvw_clth_dialog_perpiece_price_dry_clean);
        TextView clthtotalprice = builder.findViewById(R.id.txtvw_clth_dialog_total_price_dry_clean);
        ImageView incrbtn = builder.findViewById(R.id.imgvw_decrement_quantity_dry_clean);
        ImageView decrbtn = builder.findViewById(R.id.imgvw_increment_quantity_dry_clean);
        TextView quantitytext = builder.findViewById(R.id.txtvw_quantity_dry_clean);
        TextView catg_namee = builder.findViewById(R.id.txtvw_dialog_catg_name_dry_clean);
        Button addbagbtn = builder.findViewById(R.id.btn_add_to_bag_dry_clean);
...
//        AlertDialog dialog = builder.create();
    ...
    public Filter getFilter() {
        if (searchDryClean==null){
            searchDryClean = new SearchDryClean(this,selectClothsPojos);
        }
        return searchDryClean;
    }
